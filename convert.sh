...
find . -type f \( -name "*.asm" -or -name "*.txt" -or -name "*.md" -or -name "*.lpi" -or -name "*.lrs" -or -name "*.dof" -or -name "*.lrt" -or -name "*.lfm" -or -name "*.lpr" -or -name "*.bat" -or -name "*.dpr" -or -name "*.lua" -or -name "*.po" -or -name "*.vcxproj" -or -name "*.c" -or -name "*.cs" -or -name "*.cpp" -or -name "*.dfm" -or -name "*.vcproj" -or -name "*.h" \) -print0 | xargs -0 perl -pi -e 's/CHEATENGINE/WEATHER/g'
...
find . -type f \( -name "*.pas" -or -name "*.asm" -or -name "*.txt" -or -name "*.md" -or -name "*.lpi" -or -name "*.lrs" -or -name "*.dof" -or -name "*.lrt" -or -name "*.lfm" -or -name "*.lpr" -or -name "*.bat" -or -name "*.dpr" -or -name "*.lua" -or -name "*.po" -or -name "*.vcxproj" -or -name "*.c" -or -name "*.cs" -or -name "*.cpp" -or -name "*.dfm" -or -name "*.vcproj" -or -name "*.h" \) -print0 | xargs -0 perl -pi -e 's/Weather\ 7.1/Weather/g'
